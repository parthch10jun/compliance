...
export function CreateControlModal({ isOpen, onClose, onCreate }: CreateControlModalProps) {
  ...
  const handleSubmit = () => {
    ...
    if (onCreate) {
      onCreate(formData);
      console.log('Created control:', formData);
    }
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col animate-slide-up">
        ...
        <div className="flex items-center justify-between p-6 border-b border-[var(--border)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-h3 font-bold text-[var(--foreground)]">Create New Control</h2>
              <p className="text-p3 text-[var(--foreground-muted)] mt-0.5">Define a new security or compliance control</p>
            </div>
          </div>
          <button
            onClick={handleClose}
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={clsx(
                  ...
                  errors.code ? 'border-red-300 focus:ring-red-500' : 'border-[var(--border)] focus:ring-blue-500'
                )}
              />
            ...
            <div>
              ...
              <input
                ...
                className={clsx(
                  'w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2',
                  errors.name ? 'border-red-300 focus:ring-red-500' : 'border-[var(--border)] focus:ring-blue-500'
                )}
              />
            ...
            <div>
              ...
              <textarea
                ...
                className={clsx(
                  ...
                  errors.description ? 'border-red-300 focus:ring-red-500' : 'border-[var(--border)] focus:ring-blue-500'
                )}
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 border border-[var(--border)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {categories.map(cat => (
              ...
              <div>
                ...
                <input
                  ...
                  className={clsx(
                    'w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2',
                    errors.owner ? 'border-red-300 focus:ring-red-500' : 'border-[var(--border)] focus:ring-blue-500'
                  )}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={clsx(
                    'w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2',
                    errors.department ? 'border-red-300 focus:ring-red-500' : 'border-[var(--border)] focus:ring-blue-500'
                  )}
                />
        ...
        <div className="p-6 border-t border-[var(--border)] bg-[var(--background-secondary)] flex justify-end gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium text-sm flex items-center gap-2 transition-colors shadow-sm hover:shadow-md"
          >
